...
countries = [
    ...
    "Kyrgyzstan","Morocco", "Mexico", "Russia",
...
feature_names = {
    ...
    "INF_lag1": "Previous Year Consumer Price Index (%)",
    ...
    "UNEMP_lag1": "Previous Year Unemployment Rate (%)",

    # --- Corruption ---
    "CORR": "Control of Corruption Index",
    "CORR_lag1": "Previous Year Control of Corruption",

    # --- Foreign reserves ---
    "FRES": "Foreign Reserves USD$",
    "FRES_lag1": "Previous Year Foreign Reserves USD$",
    ...
    # --- Oil ---
    "OIL": "Oil Price per Barrel USD$",
    "OIL_lag1": "Previous Year Oil Price per Barrel USD$",
    ...
    # --- Gold ---
    "GOLD": "Gold Price per gram USD$",
    "GOLD_lag1": "Previous Year Gold Price per gram USD$",
}
...
""", unsafe_allow_html=True)
    ...
    country_cards = [
        ...
        "description": "Morocco is a stable and diversified economy in North Africa with a strategic location connecting Europe, Africa, and the Middle East. The country’s economy is driven by agriculture, tourism, manufacturing, and phosphate exports. In recent years, Morocco has also invested in renewable energy, especially solar and wind power, supporting long-term economic development."
        }
